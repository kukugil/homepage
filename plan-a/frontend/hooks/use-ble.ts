...
// Known service UUIDs that BLE MCU devices commonly expose
const KNOWN_SERVICES = [
  // Standard SIG-adopted services
  "0000180a-0000-1000-8000-00805f9b34fb", // Device Information
  "00001800-0000-1000-8000-00805f9b34fb", // Generic Access (device name)
  "00001801-0000-1000-8000-00805f9b34fb", // Generic Attribute
  "0000180f-0000-1000-8000-00805f9b34fb", // Battery Service
  // Nordic UART Service (very common on nRF52-based MCUs)
  "6e400001-b5a3-f393-e0a9-e50e24dcca9e",
  // Common custom vendor services (TI, Espressif, etc.)
  "0000ff00-0000-1000-8000-00805f9b34fb",
  "0000fff0-0000-1000-8000-00805f9b34fb",
  "0000ffe0-0000-1000-8000-00805f9b34fb",
]

// Characteristics that may contain device identification
const KNOWN_SN_CHARACTERISTICS = [
  ...
  "00002a00-0000-1000-8000-00805f9b34fb", // Device Name (Generic Access)
  "00002a01-0000-1000-8000-00805f9b34fb", // Appearance
  // Nordic UART TX characteristic (custom devices often put SN here)
  "6e400002-b5a3-f393-e0a9-e50e24dcca9e",
  // Common custom characteristic UUIDs for vendor data
...
export function useBle() {
  ...
  const connect = useCallback(async () => {
    ...
    try {
      // Step 1: scan all nearby BLE devices, including common MCU services
      // This widens the scan beyond just standard UUIDs
      ...
      if (err instanceof Error) {
        ...
        if (msg.includes("filters") || msg.includes("filter")) {
          throw new Error(
            "蓝牙扫描参数错误。\n请刷新页面后重试"
          )
        }
    ...
    try {
      const server = await new Promise<BluetoothRemoteGATTServer>((resolve, reject) => {
        ...
        device.gatt!.connect()
          .then((s) => { clearTimeout(timeout); resolve(s) })
          .catch((e) => { clearTimeout(timeout); reject(e) })
      })

      if (!server) throw new Error("无法连接设备 GATT 服务")

      // Step 2: try known SN characteristics across all known services
      ...
      // Step 3: iterate ALL services and ALL characteristics as last resort
      ...
      // Step 5: try reading the device name from GAP service
      try {
        ...
        if (name) return finalizeConnection(device, name)
      ...
      if (err instanceof Error) {
        if (err.message.startsWith("已连接设备")) throw err
        if (err.message.startsWith("连接 MCU 超时")) throw err
      }
