...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Upload Tab
  uploadTab: { zh: "上传文件", en: "Upload Files" },
  dragOrClickUpload: { zh: "拖拽文件到此处，或点击选择", en: "Drag files here or click to select" },
  dropToUpload: { zh: "松开以上传文件", en: "Drop to upload" },
  supportedFormats: { zh: "支持 EPUB / PDF / TXT / MP3 / BIN / FW，单文件最大 500MB", en: "Supports EPUB / PDF / TXT / MP3 / BIN / FW, max 500MB per file" },
  ...
  noBooks: { zh: "暂无文件", en: "No files yet" },
  goToUploadHint: { zh: "切换到「上传文件」标签页开始添加", en: "Switch to Upload tab to add files" },
  goToUpload: { zh: "前往上传", en: "Upload" },
  totalBooks: { zh: (n: number) => `共 ${n} 个文件`, en: (n: number) => `${n} files` },
  ...
  unknownTitle: { zh: "未知文件", en: "Unknown File" },
  unknownAuthor: { zh: "未知", en: "Unknown" },
  loadFailed: { zh: "加载失败", en: "Load failed" },
  deleteFailed: { zh: "删除失败", en: "Delete failed" },

  // File List
  bookListTab: { zh: "文件列表", en: "File List" },
